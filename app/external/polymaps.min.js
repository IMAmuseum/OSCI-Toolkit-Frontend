...
po.wheel = function() {
  ...
  inner = document.getElementById("polymaps-scrollfix-inner");
  outer = document.getElementById("polymaps-scrollfix-outer");

  if( !inner || !outer ) {
    var inner = document.createElement("div"),
        outer = document.createElement("div");

    inner.setAttribute("id", "polymaps-scrollfix-inner");
    outer.setAttribute("id", "polymaps-scrollfix-outer");
  } 
