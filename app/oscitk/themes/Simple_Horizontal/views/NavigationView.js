OsciTk.views.Navigation = OsciTk.views.BaseView.extend({
	...
	initialize: function() {
		...
		// This sets the publication's author and title for the template
	...
	getPageForSelector: function( e ) {
    	var $e = $(e);
    	if( $e.length > 0 ) {
   			return $e.offset().left / $(document).width();
   		}else{
   			return 0;
   		}
